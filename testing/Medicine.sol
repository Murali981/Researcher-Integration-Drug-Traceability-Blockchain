...
contract Medicine {
    ...
    mapping(uint => MedicineDetails) public medicineDetails;
    ...
    //   function getMedicineDetails(uint _medicineId) public view returns (
    //     bytes32 description,
    ...
    //     address txnContractAddress
    // ) {
    //     require(_medicineId > 0 && _medicineId <= totalMedicines, "Invalid medicineId");
    //     MedicineDetails storage details = medicineDetails[_medicineId];
    //     return (
    //         details.description,
    //         details.rawMaterials,
    //         details.transporters,
